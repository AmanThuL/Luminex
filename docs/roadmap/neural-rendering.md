...
**M7 → R2 → R3 → R4 → UX2 → UX3 → N1 → M9 → M8 → M10 → M11**, with N2–N4 entering when their prerequisites below
...
|---|---|---|
| N1 inference lab | Gate B; no M-slice | First N-slice, after M7, R2–R4, UX2 and UX3 in the accepted order; N1.1 → N1.2 → N1.3 → N1.4 on the recorded machine; acceleration gate needs an M5-class device |
