...
**Deliver:**
`Tests/` mirroring `Source/` to `Render/Passes/<family>` and `App/Model/<feature>`, plus `Tools`, `Support` and `Golden`, as the [record](../milestones/r/r3.7.md) tabulates (landed under its [plan](../plans/2026-09-23-r3.7-tests.md); validation pending), with
