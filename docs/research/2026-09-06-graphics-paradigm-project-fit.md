...
| [Render graph](../../Source/Render/Graph/RenderGraph.h), [graph model](../../Source/App/Model/GraphNodeModel.h), [layout](../../Source/App/Model/GraphLayout.h) | Pass/resource/barrier inspection and exact retired-frame evidence | No device execution graph, command-processor counter, or causal bottleneck diagnosis |
