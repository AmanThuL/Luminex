...
|---|---|---|
| [CommandList](../../RojoRHI/Include/rojoRHI/CommandList.h), [indirect arguments](../../RojoRHI/Include/rojoRHI/Indirect.h), [GPU tests](../../RojoRHI/Tests/GpuIndirectTests.cpp) | Compute-written arguments, explicit hazards, GPU correctness checks | Each indirect call still encodes one command; no public ICB/batched execution API |
| [Renderer](../../Source/Render/Renderer/Renderer.cpp), [frame-data decision](../decisions/0010-execution-model-partial-reshape.md) | Retained object model with efficient frame-owned data | Production iterates draw items; GPU addresses are not persistent GPU scene ownership |
...
| [Render graph](../../Source/Render/Graph/RenderGraph.h), [graph model](../../Source/App/Model/Graph/GraphNodeModel.h), [layout](../../Source/App/Model/Graph/GraphLayout.h) | Pass/resource/barrier inspection and exact retired-frame evidence | No device execution graph, command-processor counter, or causal bottleneck diagnosis |
| `../../Shaders/Modules/Lighting.slang`, [BRDF oracle](../../Tests/Support/BrdfOracle.h), `../../Source/Scene/SceneLibrary.h` | Analytic PBR and controlled material/image checks | No training, neural weights, or MaterialX compiler |
