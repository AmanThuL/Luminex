...
| 11 | [R3.1–R3.7](roadmap/codebase-restructuring.md#r3--subsystems-and-tree-restructure) Donut-style subsystems and tree restructure | III | R3.1–R3.5 implemented; R3.5 owner-accepted 2026-09-22 with a scoped part A parity exception and plan closed; R3.6 A owner-accepted with one scoped parity exception; B not started; R3.7 inactive; [series record](milestones/r/r3.md) | R2 |
