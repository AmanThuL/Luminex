...
| 8 | [M7.4](roadmap/gpu-driven-hybrid-rendering.md#m74--conservative-occlusion) conservative occlusion | II | Implemented; verification recorded; owner review pending; image gate failed 13/15 | M7.3 |
