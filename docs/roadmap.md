...
| 11 | [R3.1–R3.7](roadmap/codebase-restructuring.md#r3--subsystems-and-tree-restructure) Donut-style subsystems and tree restructure | III | R3.1–R3.4 implemented; R3.5 part A implemented, part B executing; R3.6–R3.7 inactive; [series record](milestones/r/r3.md) | R2 |
