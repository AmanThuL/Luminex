...
| 12 | [R4.1–R4.2](roadmap/codebase-restructuring.md#r4--shader-source-deduplication) shader source deduplication | III | R4.1 implemented 2026-09-24, plan closed, DEFER under its fixed rule pending owner review ([validation](milestones/r/r4.1-validation.md)); [proposed record](milestones/r/r4.md) | R3 |
