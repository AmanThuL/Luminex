...
//======================================================================================================================
// The world pose of one baked sample, as the rigid track stores it. It goes through the Asset's
...
AssetResult<GltfScene> loadGltf(std::string_view path) {
    ...
    for (cgltf_size i = 0; i < data->materials_count; ++i) {
        ...
        out.alphaMode =
            mat.alpha_mode == cgltf_alpha_mode_mask ? GltfAlphaMode::Mask : GltfAlphaMode::Opaque;
