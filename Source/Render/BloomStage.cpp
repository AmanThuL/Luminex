...
//======================================================================================================================
rhi::Result<void> BloomStage::loadLibraries(rhi::Device& device) {
...
//======================================================================================================================
rhi::Result<void> BloomStage::createPipelines(rhi::Device& device) {
...
//======================================================================================================================
GraphTexture BloomStage::declare(RenderGraph& graph, rhi::CommandList& commands,
