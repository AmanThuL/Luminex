...
TEST_CASE("lighting reset and implicit clustered selection use effective content",
    ...
    settings.localLightMode = render::LocalLightMode::Off;
    ...
    CHECK_FALSE(app::lightingChangeNeedsHistoryReset(render::LocalLightMode::Direct,
                                                     render::LocalLightMode::Clustered, 0, false));
    CHECK(app::lightingChangeNeedsHistoryReset(render::LocalLightMode::Clustered,
                                               render::LocalLightMode::Clustered, 0, true));
}
