...
// linear mean (1+0+0+1)/4 = 0.5, and Core/Math/Color.h's linearToSrgb(0.5) is 0.735..., byte 188
// (Tests/Render/Passes/Exposure/GpuRendererDisplayTests.cpp names 188 as the byte a scene shader
// that still encoded linear 0.5 would write).
