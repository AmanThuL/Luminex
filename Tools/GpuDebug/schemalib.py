...
The sidecar is written by RojoRHI/Source/CaptureSchema.cpp on every endCapture() call. This module
...
# The sidecar is written next to the bundle by every App-driven capture (RojoRHI/Source/
